...
class MicroPostController
{
    ...
    {
        /*$this->denyUnlessGranted('edit', microPost); //this could be used if we extended the controller class
        if ($this->authorizationChecker->isGranted('edit', $microPost)) { // security annotation is more convenient
